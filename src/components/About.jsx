    ...
    return (
        <div className='w-full'>
            <div className='flex flex-col justify-center items-center py-20 max-w-[1200px] mx-auto'>
                ...
                <h1 className='font-bold text-5xl'>Trusted by Developers Around the World</h1>
                <p className='text-gray-700 font-normal text-xl max-w-[1200px] text-center mt-6'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Debitis placeat distinctio omnis iusto impedit expedita accusantium fugiat nemo eligendi beatae.</p>

                <div className='flex flex-row'>

                    <div className='px-24 py-12 shadow-lg rounded-lg w-full'>
